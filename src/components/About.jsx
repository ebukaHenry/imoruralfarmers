        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Rural Farmers NGO is a non-profit organization committed to improving the lives of farmers in rural areas. We work directly with farming communities to address challenges and unlock opportunities for sustainable agricultural growth.
            </p>
